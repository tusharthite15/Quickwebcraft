...
// const { updateSubcategory } = require('../controllers/Category');
...
const {
  ...
  getAllBlocks,
  updateBlock,
  getAllBlocksBycategoryName,
  getBlocksBySubcategoryName,
  getTemplateBlock // New function
...
// New route for fetching a template block
// app.get('/getTemplateBlock/:blockId', getTemplateBlock);
